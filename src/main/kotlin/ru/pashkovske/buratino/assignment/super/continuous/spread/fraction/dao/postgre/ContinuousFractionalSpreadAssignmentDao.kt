...
import ru.pashkovske.buratino.assignment.`super`.base.dao.postgre.PostgreSuperAssignmentDao
...
class ContinuousFractionalSpreadAssignmentDao(
    ...
    >(
        ...
        r2dbcEntityTemplate = r2dbcEntityTemplate,
        nestedAssignmentDao = fractionalSpreadAssignmentDao
    )
